...
import UnlockPremiumAccess from "@/components/personas/membership/unlock-access";
...
export default function Page() {
        ...
        async function fetchInitData() {
            try {
                ...
                if (data?.status) {
                    ...
                    setMemberList(data?.data?.member_list);
    ...
    // If not membership purchase
    if (!isLoading && !membership?.id) {
        return (
            <>
                <CommonHeader />
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-yellow-100 border border-yellow-300 text-black p-4 rounded-lg text-base">
                                    {membership?.plan_name === 'family' ? (
                                        <>
                                            You have purchased <span className="font-semibold">{membership?.plan_name}</span> plan for up to <span className="font-semibold">4 family members</span>.
                                        </>
                                    ) : (
                                        <>
                                ...
                                {membership?.plan_name === 'family' && (
                                    <div className="text-center pt-6 space-y-6">
                                        ...
                                        <p className="text-xs text-gray-500">
                                            Your family DNA will be synchronized to generate the perfect shared itinerary.
                                        </p>
                                    </div>
                                )}
                            </div>
